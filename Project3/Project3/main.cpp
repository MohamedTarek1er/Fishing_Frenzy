...
void mainMenu(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music);
...
int main()
{
	RenderWindow window(VideoMode(1920, 1080), "Feeding Frenzy", Style::Fullscreen);
	...
	SoundBuffer mousedownbuffer, mouseoverbuffer, introbuffer, stagebuffer;
	...
	Sound mousedownsound, mouseoversound, introsound, stagesound;
	...
	mainMenu(window, mousedownbuffer, mousedownsound, mouseoverbuffer, mouseoversound, introbuffer, introsound, stagebuffer, stagesound, music);
	return 0;
}

void mainMenu(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music)
{
	menuFunc menu(window.getSize().x, window.getSize().y);
	menu.menu[0].setString("Play");
	menu.menu[0].setPosition(Vector2f(890, 435));
	menu.menu[0].setCharacterSize(70);

	menu.menu[1].setString("Instructions");
	menu.menu[1].setPosition(Vector2f(760, 600));
	menu.menu[1].setCharacterSize(70);

	menu.menu[2].setString("Credits");
	menu.menu[2].setPosition(Vector2f(830, 765));
	menu.menu[2].setCharacterSize(70);

	menu.menu[3].setString("Exit");
	menu.menu[3].setPosition(Vector2f(880, 930));
	menu.menu[3].setCharacterSize(70);

	Texture backgroundTexture;
	backgroundTexture.loadFromFile("Resources/Backgrounds/backgroundf.jpg");
				...
				while (window.pollEvent(event))
				{
					...
					if (event.type == Event::KeyReleased)
					{
						...
						if (event.key.code == Keyboard::Return)
						{
							...
							if (menu.getSelected_item() == 0)
								pagenumber = 1;
							else if (menu.getSelected_item() == 1)
								pagenumber = 2;
							else if (menu.getSelected_item() == 2)
								pagenumber = 3;
							else if (menu.getSelected_item() == 3)
								pagenumber = 4;
						}
					}
				}
...
void instructions(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music)
{
	...
	instructionsTexture.loadFromFile("Resources/backgrounds/instructions.png");
...
void Levels(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music)
{
	...
	menu.menu[0].setString("1 | Humble Beginnings");
	menu.menu[0].setPosition(Vector2f(335, 320));
	menu.menu[0].setCharacterSize(55);
	menu.menu[0].setFont(font);
	menu.menu[0].setOutlineColor(Color::Black);
	menu.menu[0].setOutlineThickness(2);

	menu.menu[1].setString("2 | Time Bounded");
	menu.menu[1].setFont(font);
	menu.menu[1].setPosition(Vector2f(335, 450));
	menu.menu[1].setCharacterSize(55);

	menu.menu[2].setString("3 | Wasteland");
	menu.menu[2].setPosition(Vector2f(335, 580));
	menu.menu[2].setFont(font);
	menu.menu[2].setCharacterSize(55);

	menu.menu[3].setString("4 | Into the Abyss");
	menu.menu[3].setPosition(Vector2f(335, 710));
	menu.menu[3].setFont(font);
	menu.menu[3].setCharacterSize(55);
	...
	//LEVEL PREVIEW
	int selectedLevel = 0, changedLevel = 0;
	...
	//Minnow
	Entity s_Fish[10];
	Texture s_FishTexture;
	s_FishTexture.loadFromFile("Resources/Sprites/Minnow.png");
	int s_Fish_currentFrame[10] = {};
	int s_Fish_directionRand[10];
	Clock s_Fish_clock[10];
	float s_Fish_time[10];
	for (int i = 0; i < 10; i++)
	{
		s_Fish[i] = { 0, 0, 1, 14, 5, 0, 3.75f, 0.375f, 0.05f };
		s_Fish[i].sprite.setTexture(s_FishTexture);
		s_Fish[i].sprite.setTextureRect(IntRect(66, 0, -66, 49));
		s_Fish[i].sprite.setPosition(Vector2f(rand() % 1854, rand() % 1031));
		s_Fish_directionRand[i] = rand() % 8;
	}
	//Surgeonfish Orange
	Entity m_Fish[4];
	Texture m_FishTexture;
	m_FishTexture.loadFromFile("Resources/Sprites/Surgeonfish.png");
	int m_Fish_currentFrame[4] = {};
	int m_Fish_directionRand[4];
	Clock m_Fish_clock[4];
	float m_Fish_time[4];
	for (int i = 0; i < 4; i++)
	{
		m_Fish[i] = { 10, 1, 2, 13, 4, 5, 3.f, 0.3f, 0.16875f };
		m_Fish[i].sprite.setTexture(m_FishTexture);
		m_Fish[i].sprite.setTextureRect(IntRect(171, 0, -171, 106));
		m_Fish[i].sprite.setPosition(Vector2f(rand() % 1749, rand() % 974));
		m_Fish_directionRand[i] = rand() % 8;
	}
	//Dory green
	Entity L_Fish[2];
	Texture L_FishTexture;
	L_FishTexture.loadFromFile("Resources/Sprites/John Dory.png");
	int L_Fish_currentFrame[2] = {};
	int L_Fish_directionRand[2];
	Clock L_Fish_clock[2];
	float L_Fish_time[2];
	for (int i = 0; i < 2; i++)
	{
		L_Fish[i] = { 20, 1, 2, 14, 4, 6, 2.25f, 0.225f, 0.1875f };
		L_Fish[i].sprite.setTexture(L_FishTexture);
		L_Fish[i].sprite.setTextureRect(IntRect(181, 0, -181, 181));
		L_Fish[i].sprite.setPosition(Vector2f(rand() % 1739, rand() % 899));
		L_Fish[i].sprite.setScale(1.3, 1.3);
		L_Fish_directionRand[i] = rand() % 8;
	}
	...
	while (true)
	{
		if (pagenumber == 1)
		{
			while (window.isOpen())
			{
				...
				while (window.pollEvent(event))
				{
					...
					if (event.type == Event::KeyReleased)
					{
						...
						if (event.key.code == Keyboard::Return)
						{
							...
							if (menu.getSelected_item() == 1)
							{
								pagenumber = 6;
							}
							if (menu.getSelected_item() == 2)
							{
								pagenumber = 7;
							}
							if (menu.getSelected_item() == 3)
							{
								pagenumber = 8;
							}
						}
				...
				if (changedLevel != selectedLevel)
				{
					changedLevel = selectedLevel;
					if (changedLevel == 1)
					{
						s_FishTexture.loadFromFile("Resources/Sprites/Minnow.png");
						for (int i = 0; i < 10; i++)
						{
							...
							s_Fish[i].sprite.setTextureRect(IntRect(66, 0, -66, 49));
							s_Fish[i].sprite.setPosition(Vector2f(rand() % 1854, rand() % 1031));
							s_Fish[i].sprite.setScale(1, 1);
						}
					}
					else if (changedLevel == 2)
					{
						s_FishTexture.loadFromFile("Resources/Sprites/Angelfish blue.png");
						for (int i = 0; i < 10; i++)
						{
							s_Fish[i] = { 0, 2, 3, 14, 5, 0, 3.75f, 0.375f, 0.05f };
							s_Fish[i].sprite.setTexture(s_FishTexture);
							s_Fish[i].sprite.setTextureRect(IntRect(126, 106, -126, 106));
							s_Fish[i].sprite.setPosition(Vector2f(rand() % 1794, rand() % 974));
							s_Fish[i].sprite.setScale(0.6, 0.6);
						}
						m_FishTexture.loadFromFile("Resources/Sprites/Surgeonfish blue.png");
						for (int i = 0; i < 4; i++)
						{
							m_Fish[i] = { 10, 1, 2, 13, 4, 5, 3.f, 0.3f, 0.16875f };
							m_Fish[i].sprite.setTexture(m_FishTexture);
							m_Fish[i].sprite.setTextureRect(IntRect(171, 0, -171, 106));
							m_Fish[i].sprite.setPosition(Vector2f(rand() % 1749, rand() % 974));
							m_Fish[i].sprite.setScale(1.1, 1.1);
						}
						L_FishTexture.loadFromFile("Resources/Sprites/Layer 2.png");
						for (int i = 0; i < 2; i++)
						{
							L_Fish[i] = { 20, 1, 2, 14, 5, 5, 2.25f, 0.225f, 0.1875f };
							L_Fish[i].sprite.setTexture(L_FishTexture);
							L_Fish[i].sprite.setTextureRect(IntRect(251, 0, -251, 176));
							L_Fish[i].sprite.setPosition(Vector2f(rand() % 1669, rand() % 904));
							L_Fish[i].sprite.setScale(1.4, 1.4);
						}
					}
					else if (changedLevel == 3)
					{
						s_FishTexture.loadFromFile("Resources/Sprites/Surgeonfish2.png");
						for (int i = 0; i < 10; i++)
						{
							s_Fish[i] = { 0, 1, 2, 13, 5, 0, 3.75f, 0.375f, 0.05f };
							s_Fish[i].sprite.setTexture(s_FishTexture);
							s_Fish[i].sprite.setTextureRect(IntRect(171, 0, -171, 106));
							s_Fish[i].sprite.setPosition(Vector2f(rand() % 1749, rand() % 974));
							s_Fish[i].sprite.setScale(0.6, 0.6);
						}
						m_FishTexture.loadFromFile("Resources/Sprites/John_Dory2.png");
						for (int i = 0; i < 4; i++)
						{
							m_Fish[i] = { 10, 1, 2, 14, 5, 6, 3.f, 0.3f, 0.16875f };
							m_Fish[i].sprite.setTexture(m_FishTexture);
							m_Fish[i].sprite.setTextureRect(IntRect(181, 0, -181, 181));
							m_Fish[i].sprite.setPosition(Vector2f(rand() % 1739, rand() % 899));
							m_Fish[i].sprite.setScale(1.1, 1.1);
						}
						L_FishTexture.loadFromFile("Resources/Sprites/bigEnemy.png");
						for (int i = 0; i < 2; i++)
						{
							L_Fish[i] = { 20, 1, 2, 13, 5, 6, 2.25f, 0.225f, 0.1875f };
							L_Fish[i].sprite.setTexture(L_FishTexture);
							L_Fish[i].sprite.setTextureRect(IntRect(271, 0, -271, 121));
							L_Fish[i].sprite.setPosition(Vector2f(rand() % 1649, rand() % 959));
							L_Fish[i].sprite.setScale(1.4, 1.4);
						}
					}
					else
				...
				for (int i = 0; i < 10; i++)
				{
					enemyMovement(s_Fish[i].velocity, s_Fish[i].direction, s_Fish_directionRand[i], dt,
						s_Fish[i].maxVel, s_Fish[i].accel, s_Fish[i].resist, 60, s_Fish[i].sprite);
					s_Fish[i].sprite.move(s_Fish[i].velocity.x * dt * 60, s_Fish[i].velocity.y * dt * 60);
					animation(s_Fish[i].sprite, s_Fish_currentFrame[i], s_Fish[i].rowMotion, s_Fish[i].maxFrameMotion, s_Fish[i].velocity,
						s_Fish[i].direction, s_Fish_clock[i], s_Fish_time[i], 60);
				}
				for (int i = 0; i < 4; i++)
				{
					enemyMovement(m_Fish[i].velocity, m_Fish[i].direction, m_Fish_directionRand[i], dt,
						m_Fish[i].maxVel, m_Fish[i].accel, m_Fish[i].resist, 60, m_Fish[i].sprite);
					m_Fish[i].sprite.move(m_Fish[i].velocity.x * dt * 60, m_Fish[i].velocity.y * dt * 60);
					animation(m_Fish[i].sprite, m_Fish_currentFrame[i], m_Fish[i].rowMotion, m_Fish[i].maxFrameMotion, m_Fish[i].velocity,
						m_Fish[i].direction, m_Fish_clock[i], m_Fish_time[i], 80);
				}
				for (int i = 0; i < 2; i++)
				{
					enemyMovement(L_Fish[i].velocity, L_Fish[i].direction, L_Fish_directionRand[i], dt,
						L_Fish[i].maxVel, L_Fish[i].accel, L_Fish[i].resist, 60, L_Fish[i].sprite);
					L_Fish[i].sprite.move(L_Fish[i].velocity.x * dt * 60, L_Fish[i].velocity.y * dt * 60);
					animation(L_Fish[i].sprite, L_Fish_currentFrame[i], L_Fish[i].rowMotion, L_Fish[i].maxFrameMotion, L_Fish[i].velocity,
						L_Fish[i].direction, L_Fish_clock[i], L_Fish_time[i], 100);
				}
				...
				if (selectedLevel == 0)
				{
					...
					for (int i = 0; i < 10; i++)
						window.draw(s_Fish[i].sprite);
					for (int i = 0; i < 4; i++)
						window.draw(m_Fish[i].sprite);
					for (int i = 0; i < 2; i++)
						window.draw(L_Fish[i].sprite);
...
void Level1(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music)
{
	...
	int eatingnum = 0;
	//Pause Menu
	menuFunc pausemenu(window.getSize().x, window.getSize().y);
	pausemenu.menu[0].setString("Resume");
	pausemenu.menu[1].setString("Levels Menu");
	pausemenu.menu[2].setString("Exit");
	...
	pausemenu.menu[0].setCharacterSize(70);
	pausemenu.menu[1].setCharacterSize(65);
	pausemenu.menu[2].setCharacterSize(70);
	pausemenu.menu[0].setPosition(Vector2f(430, 430));
	pausemenu.menu[1].setPosition(Vector2f(400, 550));
	pausemenu.menu[2].setPosition(Vector2f(450, 670));

	pausemenu.menu[3].setString("");
	...
	while (true)
	{
		if (pagenumber == 5)
		{
			...
			while (window.isOpen())
			{
				...
				while (window.pollEvent(event))
				{
					...
					if (event.type == Event::KeyPressed)
					{
						...
						if (event.key.code == Keyboard::Return)
						{
							...
							if (pausemenu.getSelected_item() == 0)
							{
								pausenumber = 0;
								pausemenuisopen = false;
							}
							if (pausemenu.getSelected_item() == 1)
							{
								gamemusic.pause();
								pagenumber = 0;
							}
							if (pausemenu.getSelected_item() == 2)
							{
								pagenumber = 2;
				...
				menuFunc ok(window.getSize().x, window.getSize().y);
				ok.menu[0].setString("Return To Menu");
				ok.menu[2].setString("");
				ok.menu[1].setString("");
				ok.menu[3].setString("");
				ok.menu[0].setFillColor(Color::Red);
				ok.menu[0].setCharacterSize(120);
				ok.menu[0].setPosition(Vector2f(550, 800));
...
void Level2(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music)
{
	...
	//Clock, elapsed time, framerate independence
	Clock dt_clock, spawn_clock, movement_clock, animationClock;
	float dt;


	//Movement, spawn and random direction intialization
	float movementMultiplier = 60.f;
	float enemySpawnTimeElapsed;
	float enemyMovementTimeElapsed;
	int enemyDirectionRandomizer = 0;


	//Animation initialization
	float animationTime = animationClock.getElapsedTime().asMilliseconds();
	float animationLoopTime = 60;
	int currentFramePlayer = 0;
			...
			while (window.isOpen())
			{
				...
				while (window.pollEvent(event))
				{
					...
					if (event.type == Event::KeyPressed)
					{
						...
						if (event.key.code == Keyboard::Up && pausemenuisopen)
						{
							if (pausemenuisopen)
								mousedownsound.play();
							pausemenu.pauseMoveUp();
						}
						if (event.key.code == Keyboard::Down && pausemenuisopen)
						{
							if (pausemenuisopen)
								mousedownsound.play();
							pausemenu.pauseMoveDown();
						}
						if (event.key.code == Keyboard::Return && pausemenuisopen)
						{
							if (pausemenu.getSelected_item() == 0)
							{
								pausenumber = 0;
				...
				if (!pausemenuisopen)
				{
					...
					for (int i = 0; i < 3; i++)
					{
						enemySpawnTimeElapsed = spawn_clock.getElapsedTime().asSeconds();
					}
					//Minnow or small
					if (Minnow.size() <= 16)
					{
						if (enemySpawnTimeElapsed >= 0.5)
						{
							int side = rand() % 2;
							if (side == 0)
								enemySmall.sprite.setPosition(0 - enemySmall.sprite.getGlobalBounds().width, rand() % (WINDOW_HEIGHT - 135) + 135);
							...
							Minnow_velocity.push_back(enemySmall.velocity);
							Minnow_direction.push_back(enemySmall.direction);
							Minnow_directionRand.push_back(enemyDirectionRandomizer);
							Minnow_currentFrame.push_back(currentFrameEnemy);
							Minnow_clock.push_back(animationClock);
							Minnow_time.push_back(animationTime);

							enemySpawnTimeElapsed = spawn_clock.restart().asSeconds();
						}
					}
					...
					for (int i = 0; i < 3; i++)
					{
						enemyMovementTimeElapsed = movement_clock.getElapsedTime().asSeconds();
						if (enemyMovementTimeElapsed >= 1)
						{
							if (i == 0)
							{
								for (int j = 0; j < Minnow.size(); j++)
					...
					for (int i = 0; i < Minnow.size(); i++)
					{
						...
						animation(Minnow[i], Minnow_currentFrame[i], enemySmall.rowMotion, enemySmall.maxFrameMotion, Minnow_velocity[i],
							Minnow_direction[i], Minnow_clock[i], Minnow_time[i], animationLoopTime);
				...
				{
					frenzyMultiplier.setString("2X");
					frenzyMultiplier.setFillColor(Color::Green);
					frenzymulti = 2;
				}
				else if (frenzyColumn == 2 && frenzyRow == 6)
				{
				...
				//Timer number update
				if (30 - levelTwoTimer - timerBeforePause > 9)
					Timer.setString("00:" + to_string(30 - levelTwoTimer - timerBeforePause));
				else
					Timer.setString("00:0" + to_string(30 - levelTwoTimer - timerBeforePause));
				...
				ok.menu[0].setFillColor(Color::Red);
				ok.menu[0].setCharacterSize(120);
				ok.menu[0].setPosition(Vector2f(470, 800));
				ok.menu[2].setString("");
				ok.menu[1].setString("");
				ok.menu[3].setString("");
...
void Level3(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music)
{
	...
	ScoreSurgeonfish2Texture.loadFromFile("Resources/Sprites/Angelfish blue.png");
	...
	ScoreJohn_Dory2Texture.loadFromFile("Resources/Sprites/Surgeonfish blue.png");
	...
	ScorebigEnemyTexture.loadFromFile("Resources/Sprites/Layer 2.png");
	...
	enemySmall.texture.loadFromFile("Resources/Sprites/Angelfish blue.png");
	enemySmall.sprite.setTexture(enemySmall.texture);
	...
	Entity enemyMedium = { 10, 1, 2, 13, 4, 5, 3.f, 0.3f, 0.16875f };
	enemyMedium.texture.loadFromFile("Resources/Sprites/Surgeonfish blue.png");
	enemyMedium.sprite.setTexture(enemyMedium.texture);
	enemyMedium.sprite.setTextureRect(IntRect(171, 0, -171, 106));
	...
	enemyLarge.texture.loadFromFile("Resources/Sprites/Layer 2.png");
	enemyLarge.sprite.setTexture(enemyLarge.texture);
	...
	pausemenu.menu[1].setCharacterSize(65);
	pausemenu.menu[2].setCharacterSize(70);
	pausemenu.menu[0].setPosition(Vector2f(window.getSize().x / 4 - 50, window.getSize().y / 3 + 65));
	pausemenu.menu[1].setPosition(Vector2f(window.getSize().x / 4 - 95, window.getSize().y / 2 + 10));
	pausemenu.menu[2].setPosition(Vector2f(window.getSize().x / 4 - 40, window.getSize().y / 2 + 130));
...
void endgame(RenderWindow& window, SoundBuffer& mousedownbuffer, Sound& mousedownsound, SoundBuffer& mouseoverbuffer, Sound& mouseoversound, SoundBuffer& introbuffer, Sound& introsound, SoundBuffer& stagebuffer, Sound& stagesound, Music& music)
{
	...
	menuFunc returntomenu(1200, window.getSize().y);
	returntomenu.menu[0].setString("Back to Main Menu");
	returntomenu.menu[0].setCharacterSize(40);
	returntomenu.menu[0].setPosition(Vector2f(50, 800));


	returntomenu.menu[1].setString("Exit");
	returntomenu.menu[1].setCharacterSize(40);
	returntomenu.menu[1].setPosition(Vector2f(500, 800));

	returntomenu.menu[2].setString("Next Level");
	returntomenu.menu[2].setPosition(Vector2f(750, 800));
	returntomenu.menu[2].setCharacterSize(40);
	returntomenu.menu[3].setString("");
			...
			while (window.isOpen())
			{
				...
				while (window.pollEvent(event))
				{
					...
					if (event.type == Event::KeyReleased)
					{
						...
						{
							mouseoversound.play();
							if (returntomenu.getSelected_item() == 0)
							{
								pagenumber = 1000;
							}
							else if (returntomenu.getSelected_item() == 1)
							{
								pagenumber = 999;
							}
							else if (returntomenu.getSelected_item() == 2)
							{
								pagenumber = 998;
							}
						}
